...
(
    ...
    [DATA_PEDIDO_COMPRA] DATETIME NOT NULL,
    [COD_FORNECEDOR] INTEGER  NOT NULL,
...
-- INNER JOIN
SELECT PV.DATA_PEDIDO, PV.VLR_PEDIDO_VENDA, C.NOME AS NOME_CLIENTE, V.NOME AS NOME_VENDEDOR,
FP.DES_FORMA_PAGAMENTO
...
SELECT PC.COD_PEDIDO_COMPRA, PC.VLR_PEDIDO_COMPRA, F.NOME AS NOME_FORNECEDOR, IP.COD_PRODUTO, P.NOME AS NOME_PRODUTO
FROM PEDIDO_COMPRA PC
INNER JOIN FORNECEDOR F ON F.COD_FORNECEDOR = PC.COD_FORNECEDOR
INNER JOIN ITEM_PEDIDO_COMPRA IP ON IP.COD_PEDIDO_COMPRA = PC.COD_PEDIDO_COMPRA
